    ...
    <WorkspaceGuard>
      <div className="mx-auto w-full max-w-5xl py-12 px-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="mb-12 flex flex-col gap-2">
          <h1 className="text-4xl font-black tracking-tight text-[#f8fafc]">Workspace Sovereignty</h1>
          <p className="text-[#94a3b8] font-medium max-w-lg italic">This workspace instance is private and under your control.</p>
        </div>
