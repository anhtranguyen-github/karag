        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-muted-foreground font-medium">Create an account to manage documents, models, and storage</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        <div className="space-y-6">
                            <div className="relative group/field">
                                <label htmlFor="register-full-name" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground ml-4 mb-2 block">
                                    Full Name
                                </label>
                            ...
                            <div className="relative group/field">
                                <label htmlFor="register-email" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground ml-4 mb-2 block">
                                    Email Address
                                </label>
                                <div className="relative">
                            ...
                            <div className="relative group/field">
                                <label htmlFor="register-password" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground ml-4 mb-2 block">
                                    Password
                                </label>
                                <div className="relative">
