...
class DocumentUploadService:
    ...
    async def run_url_ingestion_background(
        ...
        from src.backend.app.services.document.ingestion.url_strategy import URLIngestionStrategy
    ...
    async def run_github_background(self, task_id: str, repo_url: str, branch: str, workspace_id: str):
        ...
        from src.backend.app.services.document.ingestion.github_strategy import GitHubIngestionStrategy
    ...
    async def run_sitemap_background(self, task_id: str, sitemap_url: str, workspace_id: str):
        ...
        from src.backend.app.services.document.ingestion.sitemap_strategy import (
    ...
    async def run_ingestion(
        ...
        try:
            ...
            from src.backend.app.core.telemetry import DOCUMENT_INGESTION_COUNT
    ...
    async def run_audio_background(self, task_id: str, filename: str, content: bytes, workspace_id: str):
        ...
        from src.backend.app.services.document.ingestion.audio_strategy import AudioIngestionStrategy
