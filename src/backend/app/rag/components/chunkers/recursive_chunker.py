...
class RecursiveChunker(BaseChunker):
    ...
    def __init__(self, rag_config: dict[str, Any]) -> None:
        ...
        self.separators = chunking.get("separators")
        if self.chunk_size is None or self.chunk_overlap is None or self.separators is None:
             raise ValueError("chunk_size, chunk_overlap and separators must be provided in 'chunking' config.")
