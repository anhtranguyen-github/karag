...
from app.rag.components.embedders.graph_embedder import GraphEmbedder
from app.rag.components.embedders.local_embedder import LocalEmbedder
from app.rag.components.embedders.multi_vector_embedder import MultiVectorEmbedder
...
class EmbedderManager:
    ...
    def resolve(self, rag_config: dict[str, Any]) -> BaseEmbedder:
        ...
        if not name:
             raise ValueError("No embedder component specified in 'embedding.component' config.")
