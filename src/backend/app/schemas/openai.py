...
class EmbeddingRequest(BaseModel):
    ...
    model: str = Field(..., description="Embedding model or workspace-qualified model")
    input: str | list[str] = Field(..., description="String or array of strings to embed")
    user: str | None = Field(None, description="Unique end-user identifier")
...
class EmbeddingResponse(BaseModel):
    id: str = Field(..., description="Unique identifier for the embedding request")
    object: str = Field("list", description="Object type")
    data: list[EmbeddingResponseData] = Field(..., description="Embedding list")
...
class FileObject(BaseModel):
    ...
    purpose: str = Field("assistants", description="File purpose")
    status: str | None = Field(None, description="Processing status")


class FilesResponse(BaseModel):
    object: str = Field("list", description="Object type")
    data: list[FileObject] = Field(..., description="File list")
