...
from src.backend.app.core.prompt_registry import (
    PromptStatus,
    PromptVersion,
    prompt_registry,
)
...
async def _initialize_infrastructure() -> None:
    ...
    from src.backend.app.core.path_utils import BASE_DIR
...
async def _initialize_task_system() -> None:
    ...
    from src.backend.app.services.task.task_worker import task_worker
