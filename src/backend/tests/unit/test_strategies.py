...
from src.backend.app.schemas.execution import ExecutionMode, RuntimeSettings
from src.backend.app.schemas.generation import GenerationConfig
...
def test_chunking_strategies():
    ...
    from src.backend.app.schemas.chunking import (
...
def test_generation_config_union():
    ...
    # OpenAI
    openai_json = {"provider": "openai", "model": "gpt-4o", "temperature": 0.5}
