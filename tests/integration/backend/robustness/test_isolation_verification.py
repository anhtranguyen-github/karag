...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "isolated: Mark test as requiring strict isolation")
    config.addinivalue_line("markers", "no_shared_state: Mark test that must not use shared state")
