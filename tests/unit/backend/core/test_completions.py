...
class TestParseModelName:
    ...
    def test_basic_workspace(self):
        from src.backend.app.api.v1.completions import parse_model_name
...
class TestExtractModeFromMessages:
    ...
    def test_mode_in_system_message(self):
        from src.backend.app.api.v1.completions import extract_mode_from_messages
        from src.backend.app.schemas.openai import OpenAIMessage
...
class TestBuildRagContextWithCitations:
    ...
    def test_basic_context(self):
        from src.backend.app.api.v1.completions import build_rag_context_with_citations
...
class TestBuildCitationPrompt:
    ...
    def test_default_mode(self):
        from src.backend.app.api.v1.completions import build_citation_prompt
...
class TestExtractCitationsFromContent:
    ...
    def test_single_citation(self):
        from src.backend.app.api.v1.completions import extract_citations_from_content
...
class TestCitationBuffer:
    ...
    def test_no_citation_flush_all(self):
        from src.backend.app.api.v1.completions import CitationBuffer
