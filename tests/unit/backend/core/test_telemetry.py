...
import pytest
from src.backend.app.core.middleware import ObservabilityMiddleware
...
class TestConfigureTracing:
    ...
    def test_tracing_enabled_with_invalid_endpoint(self):
        ...
        with patch(
            ...
            side_effect=RuntimeError("exporter init failed"),
        ):
            configure_tracing(
                service_name="test-service",
...
class TestInitTelemetry:
    ...
    @patch("src.backend.app.core.config.karag_settings")
