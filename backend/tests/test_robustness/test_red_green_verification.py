...
class RedGreenResult:
    ...
    def __init__(self, valid: bool, message: str, mutation: Optional[str], details: List):
        self.valid = valid
...
class MutationResult:
    ...
    def __init__(self, mutation: str, red_phase_passed: bool, 
                 green_phase_passed: bool, error: Optional[str]):
        self.mutation = mutation
...
def verify_test_file(test_file: str, source_file: Optional[str] = None) -> RedGreenResult:
    """
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "red_green: Mark test for Red-Green verification"
    )
