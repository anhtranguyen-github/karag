...
@router.post("/workspaces/{workspace_id}/api-keys", response_model=AppResponse[APIKeyCreateResponse])
...
@router.get("/usage/workspaces/{workspace_id}/stats", response_model=AppResponse[WorkspaceUsageStats])
