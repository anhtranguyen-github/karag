...
class ChatCompletionRequest(BaseModel):
    ...
    max_completion_tokens: Optional[int] = Field(None, ge=1, description="Maximum completion tokens (OpenAI compatible alias)")
...
class ChatCompletionResponseChoice(BaseModel):
    ...
    finish_reason: Optional[str] = Field("stop", description="Reason for completion finish (stop, length, content_filter, tool_calls)")
...
class ChatCompletionUsage(BaseModel):
    ...
    prompt_tokens_details: Optional[Dict[str, Any]] = Field(None, description="Details about prompt tokens")
    completion_tokens_details: Optional[Dict[str, Any]] = Field(None, description="Details about completion tokens")
