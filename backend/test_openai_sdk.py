...
async def test_chat_completion_non_streaming():
    ...
    try:
        ...
        print(
            f"  Tokens: {response.usage.total_tokens} ({response.usage.prompt_tokens} prompt, {response.usage.completion_tokens} completion)"
        )
    ...
    try:
        ...
        response = await client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "What information do you have about my documents?",
                }
            ],
            temperature=0.7,
            max_tokens=200,
