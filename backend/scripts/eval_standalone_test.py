...
class RetrievalMetrics:
    ...
    def recall_at_k(self, retrieved_doc_ids: List[str], relevant_doc_ids: List[str], k: int) -> RetrievalResult:
        ...
        return RetrievalResult(
            ...
            score=score,
            k=k,
            details={"retrieved": len(retrieved_at_k), "relevant": len(relevant), "intersection": len(retrieved_at_k & relevant)}
        )
    ...
    def precision_at_k(self, retrieved_doc_ids: List[str], relevant_doc_ids: List[str], k: int) -> RetrievalResult:
        ...
        return RetrievalResult(
            ...
            score=score,
            k=k,
            details={"retrieved": len(retrieved_at_k), "relevant_found": len(retrieved_at_k & relevant)}
        )
    ...
    def ndcg_at_k(self, retrieved_doc_ids: List[str], relevance_scores: Dict[str, float], k: int) -> RetrievalResult:
        ...
        return RetrievalResult(metric_name="ndcg", score=score, k=k, details={"dcg": dcg, "ideal_dcg": ideal_dcg})
